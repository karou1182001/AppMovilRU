...
import 'package:app_ru/ui/pages/condiciones.dart';
import 'package:app_ru/ui/pages/inicio.dart';
import 'package:app_ru/ui/pages/profile.dart';
import 'package:app_ru/ui/pages/terminos.dart';
      ...
      body: SingleChildScrollView( 
        child: Container( margin: const EdgeInsets.fromLTRB(50, 80, 50, 0),
          child: Column( crossAxisAlignment: CrossAxisAlignment.start,
            ...
            const Text("Número de teléfono", style: TextStyle(color: Colors.black, fontSize: 15, fontWeight: FontWeight.bold)),
            TextFormField(
            ),
            const SizedBox(
              height: 15,
            ...
            Container(
              ...
              const Text("Acepto ", style: TextStyle(color: Colors.grey, fontSize: 15)),
              GestureDetector(
              onTap: () => Get.to(() =>  Terminos()),
              child: const Text("términos ", style: TextStyle(color: Color.fromARGB(255, 1, 53, 96), fontSize: 15)),
              ),
              const Text("y ", style: TextStyle(color: Colors.grey, fontSize: 15)),
              GestureDetector(
              onTap: () => Get.to(() =>  Condiciones()),
              child: const Text("condiciones.", style: TextStyle(color: Color.fromARGB(255, 1, 53, 96), fontSize: 15)),
              ),
              ],
            ),
            GestureDetector(
          ...
          Row( mainAxisAlignment: MainAxisAlignment.center,
            children: [
              ...
              child: const Text("inicia sesión", style: TextStyle(color: Color.fromARGB(255, 1, 53, 96), fontSize: 15)),
              ),
            ],
          ),
                ],
