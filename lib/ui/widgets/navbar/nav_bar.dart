    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: CurvedNavigationBar(
          ...
          height: 75.0,
          items: <Widget>[
            Icon(navBtn[0].icon, size: 20,color: Colors.white,),
            Icon(navBtn[1].icon, size: 20,color: Colors.white),
            Icon(navBtn[2].icon, size: 20,color: Colors.white),
            Icon(navBtn[3].icon, size: 20,color: Colors.white),
            Icon(navBtn[4].icon, size: 20,color: Colors.white),
          ],
          color: colorp1,
